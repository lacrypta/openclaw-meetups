...
export async function POST(
  ...
  try {
    ...
    const subject = `Test email from ${integration.name}`;
    const html = `<h2>Test Email</h2><p>This is a test email sent from the <strong>${integration.name}</strong> integration.</p><p>If you received this, your email configuration is working correctly.</p>`;
