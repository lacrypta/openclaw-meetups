...
export function ScheduleSection() {
  const eventDate = new Date(MEETUP_DATE);
    ...
    <section id="experiencias" className="dark-section bg-[#121212] rounded-t-[32px] py-24 md:py-32">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <p className="text-white/50 text-base md:text-lg max-w-lg mb-16">
          Segundo encuentro de la comunidad OpenClaw en Buenos Aires. +180 personas, dos bloques de charlas y una noche que no queríamos que terminara.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              <span className="text-white/40 text-xs font-medium uppercase tracking-wide">Asistentes</span>
              <p className="text-white text-xl font-bold mt-1">+180 personas</p>
              <p className="text-white/40 text-sm mt-0.5">Gracias a todxs lxs que se acercaron</p>
            </div>
          </div>

          {/* Right - Agenda timeline */}
          <div>
            <h3 className="text-white text-xl font-bold mb-8">Así fue la noche.</h3>
