...
export const en: Translations = {
  ...
  login: {
    ...
    bunkerQrDesc: "Scan the QR with your bunker app (Amber, nsecBunker)",
    bunkerWaiting: "Waiting for connection...",
    bunkerManualLink: "Have a bunker:// URL?",
    bunkerQrLink: "Scan QR code",
    bunkerCopied: "URI copied",
    bunkerOpenApp: "Open in app",
