...
export const es: Translations = {
  ...
  login: {
    ...
    bunkerQrDesc: "Escaneá el QR con tu app bunker (Amber, nsecBunker)",
    bunkerWaiting: "Esperando conexión...",
    bunkerManualLink: "¿Tenés una URL bunker://?",
    bunkerQrLink: "Escanear QR",
    bunkerCopied: "URI copiada",
    bunkerOpenApp: "Abrir en app",
